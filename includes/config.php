...
// Percentage of members that have to vote for a challenge to be active
define('VOTE_PERCENTAGE_REQUIRED',0.10);

// Time to accept an open challenge (8 hours)
define('CHALLENGE_ACCEPT_PERIOD', 8 * 60 * 60);

// Cost to create a challenge
define('CHALLENGE_CREATION_PRICE',5);
